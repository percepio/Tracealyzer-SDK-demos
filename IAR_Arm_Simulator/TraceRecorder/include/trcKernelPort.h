...
#define TRC_PLATFORM_CFG "EXAMPLE"
#define TRC_PLATFORM_CFG_MAJOR 1
#define TRC_PLATFORM_CFG_MINOR 0
#define TRC_PLATFORM_CFG_PATCH 1

#define TRC_KERNEL_PORT_ALLOC_CRITICAL_SECTION() uint32_t TRACE_ALLOC_CRITICAL_SECTION_NAME;
...
#define PSF_EVENT_SEMAPHORE_DELETE                                            0x1F
