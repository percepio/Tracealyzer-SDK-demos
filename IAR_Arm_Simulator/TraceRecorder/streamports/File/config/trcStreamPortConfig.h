 ...
 *
 * Note that using the internal buffer requires the TzCtrl task to run, so 
 * xTraceTzCtrl() is called periodically. This is not provided by default when
 * using the BareMetal kernelport.
 */
